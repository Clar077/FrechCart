...
//             <button onClick={confirmCashPayment}  className='btn main-bg-color text-white'>  Confirm Cash Payment </button>
//             <button onClick={confirmOnlinePayment} className='btn main-bg-color text-white mx-3'>  Confirm online Payment </button>
//         </form>
//     </div>
