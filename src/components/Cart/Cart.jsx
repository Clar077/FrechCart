...
//   if ( cartProducts.length === 0 ){
//     return <>
//     <h1 className='main-Color'>No Data Found In Your Crat  <Link className='main-color' to="/products"> Get Some Products</Link></h1>
//     </>
//   }
...
//      <div className='container py-5 shop-cart-bg'>
//           <h2 className='py-2'>Shop Cart :</h2>
//           <h5 className='main-color text-muted'>Total Cart Price : {totalCartPrice} EGP </h5>
